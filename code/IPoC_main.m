...
%% Error states and their covariances
% 
% figure; 
% dx_1 = x_k(1,:)-x_e(1,:);
...
ylabel('$\dot{x}(t) \ [m/s]$', fontsize=13);

subplot(2, 1, 2); hold on; 
plot(tt, x_k(2,:), linewidth=2.5); 
